...
;(function($) {
	...
	var methods = {
      ...
      try{
        ...
        //Amitesh this element create syntax is not working...
        var $score = $this.append( '<input type="hidden" name="' + opt.scoreName + '"/>' );
      ...
      //self.mouseleave(function() {
        ...
        //self.children('.raty-cancel').mouseenter(function() {
				self.children('.raty-cancel').mouseover(function() {
					$(this).attr('src', opt.path + opt.cancelOn);

					$stars.attr('src', opt.path + opt.starOff);

					methods.setTarget.call(self, null, true);
				}).mouseout(function() { // Amitesh : replaced mouseleave => mouseout
        ...
        $this.mouseout().children('input').removeAttr('value');
			});
			...
			return this.each(function() {
				...
				var opt = $(this).get(0).data_options;
